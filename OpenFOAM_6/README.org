...
This is a precompiled OpenFOAM repository built for i386 processors on Linux. 
This repository was compiled on an Ubuntu 18.04 LTS distribution with an i386 
AMD processor using g++ 7.3.0 and GCC 7.3.0.
